...
test('calculates hand order properly', () => {
  ...
  let flushV1Calc = calculate(flushV1, handValues);
  let flushV2Calc = calculate(flushV2, handValues);
